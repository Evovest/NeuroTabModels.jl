...
# NeuroTree - A differentiable tree operator for tabular data {#NeuroTree-A-differentiable-tree-operator-for-tabular-data}
...
1. _Selection of the feature on which to apply the condition_.
...
1. _Selection of the condition&#39;s threshold value_.
